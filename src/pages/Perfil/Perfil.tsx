...
export default function Perfil() {
  ...
  return (
    <Default>
      ...
      <div className="flex justify-center bg-gray100 rounded-md shadow-md p-3 ">
        <div className="flex justify-center flex-col bg-white rounded shadow p-5 w-full">
          <div>
          ...
          <div className="flex justify-center flex-col md:flex-row gap-2 md:gap-3 md:mt-3 mt-2">
            <Button variant="contained" color="success" className="font-inter">
              Criar Usuário
            </Button>
            <Button variant="contained" color="error" className="font-inter">
              Cancelar
            </Button>
          </div>
        </div>
